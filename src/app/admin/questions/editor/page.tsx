...
[
  ...
  4. CÔNG THỨC TOÁN: Bọc trong $...$ và BẮT BUỘC có lệnh \\color{blue} ở đầu để lên màu xanh Mathtype (Ví dụ: $\\color{blue} A + B = B + A$). Viết LaTeX chuẩn, liền mạch trên 1 dòng. KHÔNG dùng \\\\\\\\\\\\\\\\ để escape.
  ...
  7. NHẬN DẠNG HÌNH ẢNH: Nếu câu hỏi có đồ thị/hình vẽ/bảng số liệu ĐI KÈM, TUYỆT ĐỐI KHÔNG mô tả chi tiết làm lệch câu gốc. Chỉ cần thêm "[CÓ HÌNH ẢNH KÈM THEO]" vào cuối "noiDung". CHỈ ĐƯỢC sửa nội dung câu gốc nếu sai đề, khi đó phải thêm "[CÂU HỎI CÓ THỂ BỊ SAI ĐỀ, ĐÃ SỬA LẠI]".`;
