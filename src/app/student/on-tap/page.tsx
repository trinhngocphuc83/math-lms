    ...
    <div className="max-w-[900px] mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        {dangMo ? (
          ...
          /* Màn ngoài trước đây chỉ có ô biểu tượng trơ ra, không có đường nào về
             Trang chính - vào rồi là kẹt, phải bấm nút lùi của trình duyệt. */
          <Link href="/student/dashboard" title="Về Trang chính"
                className="w-11 h-11 rounded-2xl bg-teal-600 hover:bg-teal-700 flex items-center
