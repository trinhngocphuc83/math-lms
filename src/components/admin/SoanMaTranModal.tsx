 ...
 * thì bị loại và liệt kê rõ. Bảng soát luôn hiện trước, sửa được số câu từng dòng, và
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[1200px] max-h-[94vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <>
              ...
              <div className="text-center py-4">
                ...
                <p className="text-xs text-gray-500 mt-3 max-w-2xl mx-auto">
                  ...
                  Soạn xong hiện bảng để thầy cô soát và sửa số câu, chỉ khi bấm nhận mới ghi vào ma trận.
                </p>
                {loi && (
                ...
                <table className="w-full min-w-[900px] text-[13px]">
                  <thead className="bg-gray-50 text-gray-500 text-[11px] uppercase font-black">
                    <tr>
                      ...
                      <th className="p-2 text-left w-[150px]">Loại câu</th>
                      <th className="p-2 text-left w-[130px]">Mức độ</th>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {dong.map((d, i) => {
                      ...
                      return (
                        <tr key={i}>
                          <td className="p-2">
                            <div className="font-bold text-gray-800">{d.math_form}</div>
                            <div className="text-[11px] text-gray-400">{d.lesson}</div>
                            {d.lyDo && <div className="text-[11px] text-fuchsia-600 italic mt-0.5">{d.lyDo}</div>}
                          </td>
                          <td className="p-2 text-gray-700 font-bold">{bankTypeLabel(d.question_type)}</td>
                          <td className="p-2 text-gray-700 font-bold">{difficultyLabel(d.difficulty)}</td>
        ...
        {dong && (
          <div className="shrink-0 flex flex-wrap items-center justify-between gap-2 px-5 py-3 border-t border-gray-100 bg-gray-50">
            <p className="text-[12px] text-gray-500 font-medium">Máy chỉ đề xuất. Thầy cô sửa số câu rồi hãy nhận.</p>
