...
import { nanBangLatex } from '@/utils/nanBangLatex';
...
export const preprocessMarkdown = (text: string): string => {
    ...
    /* Bảng egin{array} để trần (bộ bóc câu bằng AI hay trả về thế) phải bọc vào $$...$$
       thì KaTeX mới dựng thành bảng; không bọc thì in ra nguyên chữ LaTeX giữa đề bài. */
    text = nanBangLatex(text).text;
