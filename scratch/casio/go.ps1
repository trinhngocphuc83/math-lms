...
$K = @{
  ...
  "PHANSO"=@(72,417); "CAN"=@(110,417); "BINHPHUONG"=@(150,417); "LUYTHUA"=@(190,417)
  "LOG"=@(227,417); "LN"=@(267,417)
  "AM"=@(72,456); "DOPHUT"=@(110,456); "NGHICHDAO"=@(150,456); "SIN"=@(190,456)
  "COS"=@(227,456); "TAN"=@(267,456)
  "STO"=@(72,495); "ENG"=@(110,495); "MONGOAC"=@(150,495); "DONGNGOAC"=@(190,495)
  "SD"=@(227,495); "MCONG"=@(267,495)
