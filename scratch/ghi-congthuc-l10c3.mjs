...
const md = readFileSync('scratch/congthuc-l10c3.md', 'utf8');
...
const { data: bai } = await sb.from('lessons').select('id').eq('chapter_id', chOn.id).eq('title', 'Cuối chương 3').maybeSingle();
